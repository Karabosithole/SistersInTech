...
class FAQScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 151, 69, 10),
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/welcomeMukuru.png', // Replace with your image path
              fit: BoxFit.cover,
            ),
          ),
            ...
            child: ListView(
              children: <Widget>[
                FAQItem(
                  ...
                  answer:
                      'Your Mukuru Card only works within South Africa and the online '
                ...
                FAQItem(
                  ...
                  answer:
                      'Yes you can by visiting a Mukuru Agent or branch with your new ID document. '
                ...
                FAQItem(
                  ...
                  answer:
                      'Mukuru’s free Funeral Benefit will only pay-out in the event that the sender passes away, it does not cover family members but will pay out to the beneficiary that the sender listed. '
                ...
                FAQItem(
                  ...
                  answer:
                      'Unfortunately not. To ensure our high standards of security are maintained, we will never allow anyone else to use '
                ...
                FAQItem(
                  ...
                  answer:
                      'To reset, email a clear photo of yourself holding the  photo page of your ID document  to navsupport@mukuru.com.',
                ),
                FAQItem(
                  question:
                      'Do I still need to pay for premiums for my Mukuru Cover if I have the Mukuru Benefit?',
                  answer:
                      'Yes, you do. Mukuru’s Funeral Benefit is an added free benefit for the use of the Mukuru Card. If you want to be covered, you can sign up for Mukuru’s '
                ...
                FAQItem(
                  ...
                  answer:
                      'Yes, Mukuru Card can be used to make payments for various services, such as utility bills, through a bank or online payment platform that accepts the card.',
                ),
                FAQItem(
                  question: 'Where can I get more information about Mukuru?',
                  answer:
                      'For more information, visit our website at www.mukuru.com or contact our customer support team.',
                ),
              ],
            ),
          ),
